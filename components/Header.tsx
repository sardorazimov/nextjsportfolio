...
const Header = () => {
  ...
  return (
    <header className={cn('bg-[#040005]  sticky top-0 z-40 w-full backdrop-blur-lg shadow-lg shadow-purple-800',)}>
      <div className='container flex h-16 items-center'>
        <MobilNavbar />
        <MainNavbar />
        <Link href={'/'} className='text-3xl ml-1 backdrop:shadow-md'>azsams</Link>
        ...
        <Link
            ...
            >
              ...
              >
                <Github className="h-4 w-4" href='/https://github.com/sardorazimov' />
